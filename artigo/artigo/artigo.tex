...
O trabalho realizado foi construído utilizando-se a linguagem de programação JavaScript, pois não há a necessidade de comunicação com o servidor para obtenção dos resultados. Todos os métodos são processados no lado do cliente, gerando assim um bom desempenho para os cálculos. Utilizou-se o CSS3 como o elemento de definição de estilos para páginas WEB, devido ao seu padrão ser adotado pela grande parte dos navegadores disponíveis. 
