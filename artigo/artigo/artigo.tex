...
Para a construção visual do trabalho realizado, utilizou-se do Bootstrap, que é uma ferramenta de desenvolvimento WEB utilizando HTML, CSS e JavaScript, para sistemas responsivos. A ferramenta utiliza-se dos pré-processadores LESS e Sass, auxiliando na produtividade de desenvolvimento do sistema e utiliza de enquadramento de conteúdo em grid, gerindo um padrão de utilização para exibição de elementos em tela.
