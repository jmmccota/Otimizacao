...
\title{SIMO: Uma Ferramenta Online para Auxiliar o Ensino de Otimização}
...
\begin{frame}\frametitle{Autores}
	\begin{tabular}{ll}
		André R. da Cruz & \url{andrecruz@timoteo.cefetmg.br}\\ \\
		André F. R. Malta & \url{andrmalta@gmail.com}\\ \\
		Daniel G. Oliveira & \url{daniel.gdo@hotmail.com}\\ \\
		Elias L. S. Júnior & \url{eliasluizjr@gmail.com}\\ \\
		João M. M. C. Cota & \url{joao\_marcos\_cota@hotmail.com}\\ \\
	\end{tabular}
\end{frame}

\begin{section}{Introdução}

\begin{frame}\frametitle{O que é o SIMO}
	\begin{itemize}
		\item SIMO: Sistema Interativo para Métodos de Otimização
		\bigskip
		\item Plataforma online para a execução interativa de algoritmos de otimização
		\bigskip
		\item Explicações sobre os algoritmos disponíveis
	\end{itemize}
\end{frame}
...
\begin{frame}\frametitle{Objetivos}
	\begin{itemize}
		...
		\bigskip
		\item Visualizar a execução dos algoritmos
		\bigskip
...
\end{section}
\begin{section}{Conteúdo}

\begin{frame}\frametitle{Conteúdo abordado}
	\begin{itemize}
		\item Simplex
		\bigskip
...
\begin{frame}\frametitle{Simplex}
	\begin{itemize}
		\item Algoritmo para programação linear
		\bigskip
...
\begin{frame}\frametitle{\textit{Branch-and-Bound}}
	\begin{itemize}
		\item Algoritmo para programação linear inteira
		\bigskip
		\item Gera uma árvore de possíveis modelos, resolvidos pelo simplex
	\end{itemize}
\end{frame}
...
\begin{frame}\frametitle{Algoritmos de Transporte}
	\begin{itemize}
		...
		\bigskip
		\item Mais simples que a resolução do modelo via simplex
		\bigskip
		...
		\begin{itemize}
			...
			\item Menor custo
			\medskip
			\item Método da aproximação de Vogel
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}\frametitle{Web}
	\begin{itemize}
		...
		\bigskip
		\item Disponível para qualquer plataforma com acesso à internet
	\end{itemize}
\end{frame}
...
\begin{frame}\frametitle{Tecnologias}
	\begin{itemize}
		...
		\bigskip
		\item Executando na máquina do usuário
	\end{itemize}
\end{frame}
...
\begin{frame}\frametitle{Github}
  \begin{itemize}
  	...
  	\bigskip
  	\item Código aberto https://github.com/jmmccota/Otimizacao
  \end{itemize}
\end{frame}
